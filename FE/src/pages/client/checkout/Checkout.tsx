                    ...
                    <div>
                      ...
                      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="flex items-center space-x-3 text-sm sm:text-base">
                          <div
                            className={`flex items-center border-2 rounded-lg p-2 transition-all 
                    ...
                    <div>
                      ...
                      <div className="flex mt-1.5">
                        ...
                        <button
                          ...
                          className="ml-5 bg-[#00BADB] hover:bg-[#23b6cd] text-white rounded-lg my-2 p-2"
                        >
                          Áp dụng
                        </button>
                      </div>
