...
const Products = () => {
  ...
  return (
    <>
      <div>
        ...
        <div className="container lg:space-x-4 lg:mt-10  xl:-mb-3 -mb-14 mt-10 lg:-mb-[9px]">
          <div
            className={`lg:flex flex sm:flex flex-1 space-x-4 lg:ml-[385px] xl:ml-[370px] `}
          >
            <div ref={growboxRef}>
              <button
              ...
              {growboxDropdownOpen && (
                <div
                  className="absolute z-40 max-w-sm px-4 mt-10 -left-4 sm:left-0 lg:left-[385px] xl:mt-3 xl:left-[508px] sm:px-0 lg:max-w-sm opacity-100 translate-y-0 w-[300px] sm:w-[350px]"
                ...
                >
                  <div className="overflow-hidden rounded-2xl shadow-xl bg-white border border-neutral-200">
                    ...
                    <div className="p-5 bg-neutral-50 dark:border-t dark:border-neutral-200 flex items-center justify-between">
                      ...
                      <button className="nc-Button relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium px-4 py-2 sm:px-5  ttnc-ButtonPrimary disabled:bg-opacity-90 bg-slate-900 text-slate-50 shadow-xl hd-all-hoverblue-btn">
                        Áp dụng
                      </button>
                    </div>
                  </div>
            ...
            <div ref={toepfeRef}>
              ...
              {toepfeDropdownOpen && (
                <div
                  className="absolute z-40 max-w-sm px-4 mt-10 left-[120px] sm:left-[134px] lg:left-[520px] xl:mt-3 xl:left-[640px] sm:px-0 lg:max-w-sm opacity-100 translate-y-0 w-[300px] sm:w-[350px]"
                  id="headlessui-popover-panel-:r26:"
                  tabIndex={-1}
                  data-headlessui-state="open"
                  data-open=""
    ...
    "
                            ...
                            <div key={index} className="mr-2 mt-1">
                              <span className="t4s-pr-color__item flex flex-col items-center cursor-pointer">
                                <span className="t4s-pr-color__value border border-gray-400 w-5 h-5 hover:border-black hover:border-2 rounded-full">
                                  <div
                                    className={`w-[17px] h-[17px] rounded-full mt-[1px] ml-[0.5px] lg:mt-[1px] lg:hover:mt-0 lg:hover:ml-[-0.25px] ${convertColorNameToClass(color)}`}
                                  ></div>
                                </span>
                              </span>
                            </div>
        ...
        <section className="relative right-[-545px] mb-20 mt-[-40px] text-center ">
          <Link to="">
