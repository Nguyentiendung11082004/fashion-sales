...
const CommentProduct = ({
  ...
  console.log("kiểm tra selectedOrder: ", selectedOrder);
  ...
  const updateComment = useMutation({
    mutationFn: async ({ data, editIdComment }: UpdateCommentPayload) => {
      ...
      //   orderId: selectedOrder.id,
      // };
      // console.log("kiểm tra payload trước khi update: ", payload);
        ...
        onFinish={() => {
          listIdProduct?.map((id: any) => {
            ...
            if (editIdComment && InForCommentId) {
              console.log("kiểm tra payload khi update comment: ", payload);
